...
默认自动选择 12–25 分钟的**目标时长**，也可指定 5、10、20 或 30 分钟；实际音频可能明显短于或长于目标。5–6 分钟短集通过率较低（时长可达标，但主持人均衡/问句比例等边界门禁的波动更大），参见 [评测说明](docs/podcast-evaluation.md) 的短集一节。首次默认输出简体中文，浏览器记住上次选择；也支持英文及自动语言。已有 V2 产物保持兼容。
