...
export type ProviderConfig=Record<string,any>&{temperature?:number;context_window_tokens?:number;max_output_tokens?:number;study_generation_tier?:'auto'|'lite'|'full';auto_select?:boolean;compute_device?:string;allow_device_fallback?:boolean;podcast_sequence_tts?:boolean;asr_auto_select?:boolean;asr_model?:string;asr_compute_device?:string;asr_allow_device_fallback?:boolean;host_a_voice_mode?:HostVoiceMode;host_b_voice_mode?:HostVoiceMode;host_a_voiceprint_person_id?:string;host_b_voiceprint_person_id?:string;host_a_voiceprint_sample_id?:string;host_b_voiceprint_sample_id?:string};
