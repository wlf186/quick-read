...
export const podcastDownloadUrl=(artifactId:string,part:'all'|'audio'|'script'='all',scriptFormat:'both'|'markdown'|'json'='both')=>`/api/artifacts/${artifactId}/download?part=${part}&script_format=${scriptFormat}`;
